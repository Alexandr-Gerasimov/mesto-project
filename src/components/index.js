...
export const popupCard = new PopupWithForm(cardPopup, (data) => {
...
export const popupProfile = new PopupWithForm(profilePopup, (data) => {
  popupProfile.renderLoading(true);
  api
    .profileUpdate(data.name, data.status)
    .then((profile) => {
...
export const popupAvatar = new PopupWithForm(avatarPopup, (data) => {
  popupAvatar.renderLoading(true);
  api
    .avatarUpdate(data.name)
    .then((profile) => {
      userInfo.setUserInfo(profile);
      popupAvatar.close();
    })
